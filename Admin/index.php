                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card border border-primary">
                            ...
                            <div class="card-body">
                                <p style="font-size: small;" id="total-bandwidth-per-ip" class="card-text text-primary">Loading...</p>
                            </div>
                        </div>
                    </div><!-- end col -->
                    ...
                    <div class="col-lg-4">
                        <div class="card border border-danger">
                            ...
                            <div class="card-body">
                                <p style="font-size: small;" id="denied-acess-per-ip" class="card-text text-danger">Loading...</p>
                            </div>
                        </div>
                    </div><!-- end col -->
                    ...
                    <div class="col-lg-4">
                        <div class="card border border-success">
                            ...
                            <div class="card-body">
                                <p style="font-size: small;" id="total-bandwidth-per-web" class="card-text text-success">Loading...</p>
                            </div>
                        </div>
                    </div><!-- end col -->
                </div>
